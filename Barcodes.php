...
<header>
    <h2 class="PageHeader">
        <div class="flex-container">
            <span class="header-title">Barcodes</span>
        </div>
    </h2>
</header>
  ...
  <div class="container">
    <div class="account-box">
      <div class="button-container">
        ...
        <button class="btn selected" onclick="location.href='Barcodes.php'">Barcodes</button>
      </div>
    ...
    <div class="table-container">
         <table class="table" id="inventory-table">
            ...
            <tbody>
                ...
                // SQL query to fetch barcode, GeneratedBarcode, Description, Brand, Category, vendor_id, Price, and Quantity from products table
                $sql = "SELECT GeneratedBarcode, Description FROM products";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td class='clean-barcode'>" . $row['GeneratedBarcode'] . "</td>";
